...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addNumEntry("delay", &fEntry1, FAUSTFLOAT(0.25f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.00999999978f));
		ui_interface->addNumEntry("feedback", &fEntry0, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.00999999978f));
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			fRec0[(IOTA & 65535)] = (float(input0[i0]) + (fRec1[0] * fRec0[((IOTA - iTemp0) & 65535)]));
			output0[i0] = FAUSTFLOAT(fRec0[((IOTA - 0) & 65535)]);
			fRec3[(IOTA & 65535)] = (float(input1[i0]) + (fRec1[0] * fRec3[((IOTA - iTemp0) & 65535)]));
			output1[i0] = FAUSTFLOAT(fRec3[((IOTA - 0) & 65535)]);
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
			IOTA = (IOTA + 1);
		}
